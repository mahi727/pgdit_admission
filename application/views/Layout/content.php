    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="<?php echo base_url() . "assets/"; ?>#" class="small-box-footer">More info <i
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                    <li class="active"><a href="<?php echo base_url() . "assets/"; ?>#revenue-chart"
                                          data-toggle="tab">Area</a></li>
                    <li><a href="<?php echo base_url() . "assets/"; ?>#sales-chart" data-toggle="tab">Donut</a>
                    </li>
